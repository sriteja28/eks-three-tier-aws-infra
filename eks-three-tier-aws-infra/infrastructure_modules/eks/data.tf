locals {
  ...
  cluster_autoscaler_iam_policy_description = module.eks_cluster.cluster_id != null ? "EKS cluster-autoscaler policy for cluster ${module.eks_cluster.cluster_id}" : "Default Description"
...
data "aws_iam_policy_document" "cluster_autoscaler" {
  ...
  statement {
    ...
    condition {
      ...
      variable = "autoscaling:ResourceTag/kubernetes.io/cluster/${module.eks_cluster.cluster_id != null ? module.eks_cluster.cluster_id : "default"}"
      values   = ["shared"]
    }
