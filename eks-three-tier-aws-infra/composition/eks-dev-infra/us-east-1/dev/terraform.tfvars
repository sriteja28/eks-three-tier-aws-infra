...
self_managed_node_groups = {
  prod = {
    ...
    # mount EFS
    sudo mkdir /mnt/efs; sudo mount -t nfs -o nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport fs-0ec1412b8342ac0d2.efs.us-east-1.amazonaws.com:/ /mnt/efs; echo 'fs-0ec1412b8342ac0d2.efs.us-east-1.amazonaws.com:/ /mnt/efs nfs defaults,vers=4.1 0 0' >> /etc/fstab;
